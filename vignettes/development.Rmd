...
The two major classes needed would be ...

- `term_relationship` object, that showed and/or carried the relationship between variables, likely a list of `formulas`
- `path_map` object that drew the relationships between the variables, and allowed for the storage of multiple tests
