#' Create a Hypothesis
#'
#' `propose_hypothesis()` creates a `hypothesis` object that can be placed into a
...
#'
#' @rdname propose_hypothesis
#' @export
propose_hypothesis <- function(h, ...) {
	UseMethod("propose_hypothesis", object = h)
}

#' For general formula `hypothesis` objects
#' @rdname propose_hypothesis
#' @export
propose_hypothesis.formula <- function(h,
																combination,
																test,
																test_opts = NULL,
																data,
...
#' @rdname propose_hypothesis
#' @export
propose_hypothesis.list <- function(h,
														 combination,
														 test,
														 test_opts = NULL,
														 data,
...
#' @rdname propose_hypothesis
#' @export
propose_hypothesis.default <- function(h, ...) {
	stop(
		"`propose_hypothesis()` is not defined for a `", class(h)[1], "` object.",
		call. = FALSE
	)
}
...
#' @noRd
new_propose_hypothesis <- function(hypothesis,
													 combination,
													 formulae,
													 parameters,
													 test,
