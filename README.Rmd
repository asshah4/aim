...
[![Travis build status](https://travis-ci.com/asshah4/marksman.svg?branch=main)](https://travis-ci.com/asshah4/marksman)
...
[![Codecov test coverage](https://codecov.io/gh/asshah4/marksman/branch/main/graph/badge.svg)](https://codecov.io/gh/asshah4/marksman?branch=main)
<!-- badges: end -->
...
It heavily borrows from the `tidymodels` approach to modeling, and sharpens the focus to help with specific research projects.
